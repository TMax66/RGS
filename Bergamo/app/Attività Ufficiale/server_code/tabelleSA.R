        ...
        options = list(
          ...
          buttons = list(
            list(extend = "excel", text = "Scarica Tutto",
                 filename = paste0(input$finalita, " - attività ufficiale ", input$anno, " (dati aggiornati al ", format(as.Date(substr(max(conf$dtreg, na.rm = TRUE), start = 1, stop = 11)), "%d-%m-%Y"), ")"),
                 title = NULL,
                 titleAttr = "Excel",
                 exportOptions = list(
            ...
            list(extend = "excel", text = "Scarica Selezione",
                 filename = paste0(input$finalita, "- attività ufficiale al", input$anno, " (dati aggiornati al ", format(as.Date(substr(max(conf$dtreg, na.rm = TRUE), start = 1, stop = 11)), "%d-%m-%Y"), ")"),
                 title = NULL,
                 titleAttr = "Excel",
                 exportOptions = list(
