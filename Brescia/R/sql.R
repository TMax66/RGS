...
WHERE
  ...
  AND  dbo_Anag_Reparti_ConfAcc.Descrizione  =  'Sede Territoriale di Brescia'
"
...
WHERE        (Esami_Aggregati.Esame_Altro_Ente = 0) AND (Esami_Aggregati.Esame_Altro_Ente = 0) AND ({ fn YEAR(Conferimenti.Data_Accettazione) } >= 2021) AND (Anag_Reparti.Descrizione = 'Sede Territoriale di Brescia')
"
...
WHERE        (Esami_Aggregati.Esame_Altro_Ente = 0) AND (Esami_Aggregati.Esame_Altro_Ente = 0) AND ({ fn YEAR(Conferimenti.Data_Accettazione) } >= 2021) AND (dbo_Anag_Reparti_ConfAcc.Descrizione = 'Sede Territoriale di Brescia') AND 
                         (Anag_Reparti.Descrizione <> 'Sede Territoriale di Brescia')
...
WHERE
  ...
  AND  dbo.Anag_Reparti.Descrizione  =  'Sede Territoriale di Brescia'
