...
WHERE        (Esami_Aggregati.Esame_Altro_Ente = 0) AND (Esami_Aggregati.Esame_Altro_Ente = 0) AND ({ fn YEAR(Conferimenti.Data) } >= 2021) AND (Anag_Reparti.Descrizione = 'Sede Territoriale di Brescia')
"
...
WHERE        (Esami_Aggregati.Esame_Altro_Ente = 0) AND (Esami_Aggregati.Esame_Altro_Ente = 0) AND ({ fn YEAR(Conferimenti.Data) } >= 2021) AND (dbo_Anag_Reparti_ConfAcc.Descrizione = 'Sede Territoriale di Brescia') AND 
